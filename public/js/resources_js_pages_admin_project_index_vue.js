"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_pages_admin_project_index_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    viewProject: function viewProject(item) {
      this.$router.push("/dashboard/project/view/".concat(item.id));
    },
    editItem: function editItem(item) {
      this.$router.push("/dashboard/project/edit/".concat(item.id));
    },
