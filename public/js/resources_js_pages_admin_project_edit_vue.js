"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_pages_admin_project_edit_vue"],{
  ...
  data: function data() {
    return {
      ...
      imgValidate: [function (value) {
        return !!value || "اپلود عکس الزامی است و سایز باید کمتر از 2 مگابایت باشد";
      }]
    };
  },
  methods: {
    ...
    getProject: function getProject() {
      ...
      axios.get("/api/project/".concat(id), {
        headers: {
          Authorization: token
        }
      }).then(function (response) {
        ...
        _this3.category_id = project.category_id;
        _this3.name = project.name;
        _this3.status = project.status;
        _this3.material = project.material.split(",");
        _this3.short_description = project.short_description;
        _this3.description = project.description;
    ...
    editProject: function editProject() {
      ...
      var id = this.$route.params.id;
      axios.post("/api/edit/project/".concat(id), {
        name: this.name,
        status: this.status,
        material: material,
        ...
        _shared_alerts__WEBPACK_IMPORTED_MODULE_0__["default"].errorAlert("پروژه با موفقیت ویرایش نشد");
      });
    },
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this4.imageGallery_id = _this4.urls[_this4.indexOfGallery].id;

                _this4.images.splice(_this4.indexOfGallery, 1);

                _this4.urls.splice(_this4.indexOfGallery, 1);

                if (_this4.imageGallery_id) {
                  token = localStorage.getItem("adminToken");
                  axios["delete"]("/api/delete/imageGallery/".concat(_this4.imageGallery_id), {
                    headers: {
                      Authorization: token
                    }
                  }).then(function (response) {
                    _shared_alerts__WEBPACK_IMPORTED_MODULE_0__["default"].successAlert("تصویر با موفقیت حذف شد و قابل بازگردانی نیست");
                  })["catch"](function (error) {});
                }
